...
# top number, 1228, is the row name (row number of original matrix). Bottom number, 1380, is the actual row number.
mid
actg175_mat[mid,]
...
legend("bottomleft",legend = c("1380th Patient, Offtrt = 0", "575th Patient, Offtrt = 1", "Modified 575th Patient, Offtrt = 0", "Modified 1380th Patient, Offtrt = 1"),col=c(1, 2, 1, 2), lty = c(1, 1, 2, 2), lwd = 2)
```
